...
class Server {
    ...
    listen(handler) {
        if (this.handle instanceof maybe_1.Nothing) {
            ...
            this.handle = (0, maybe_1.just)(http.createServer(handler));
            return this
                .handle
                .map(h => (0, future_1.fromCallback)(cb => {
                h
                    .on('connection', s => {
                    this.sockets.push(s);
            ...
            return (0, future_1.raise)(new Error('listen: Server is already listening'));
        }
    }
    /**
     * restart the Server.
    ...
    stop() {
        return this
            ...
            .handle
            .map(close(s))
            .orJust(() => (0, future_1.pure)(s))
            .get())
            .map(() => { this.handle = (0, maybe_1.nothing)(); });
    }
    /**
    ...
    flush() {
        ...
        this.sockets = [];
        return (0, future_1.pure)(this);
    }
}
exports.Server = Server;
const close = (s) => (h) => (0, future_1.fromCallback)(cb => h.close(() => cb(undefined, s)));
