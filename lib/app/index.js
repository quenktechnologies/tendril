...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.spawnModule = function (path, parent, tmpl) {
        ...
        if (tmpl.app && tmpl.app.modules)
            record_1.map(tmpl.app.modules, function (m, k) { return _this.spawnModule(k, maybe_1.just(mctx), m); });
        if (Array.isArray(tmpl.children))
            tmpl.children.forEach(function (c) { return runtime.exec(new scripts_2.SpawnScript(address, c)); });
        return this;
    };
    /**
...
var newState = function (app) { return ({
    contexts: {
        $: newContext(maybe_1.nothing(), app, new this_1.This('$', app), {
            id: '$',
            create: function () { return new App(app.main); },
            trap: function (e) {
