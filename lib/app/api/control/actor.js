 ...
 */
const ask = (to, m) => free_1.liftF(new Ask(to, m, function_1.identity));
exports.ask = ask;
/**
 * self provides the address of the module.
 */
const self = () => free_1.liftF(new Self(function_1.identity));
exports.self = self;
/**
 * tell sends a message to another actor.
 */
const tell = (to, m) => free_1.liftF(new Tell(to, m, undefined));
exports.tell = tell;
