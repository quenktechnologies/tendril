...
class Ask extends __1.Api {
    ...
    exec(ctx) {
        ...
        return new future_1.Run(s => {
            let id = uuid.v4();
            let cb = (t) => s.onSuccess(t.value);
            ctx.module.spawn({
                id,
 ...
 */
exports.ask = (to, m) => free_1.liftF(new Ask(to, m, function_1.identity));
/**
 * self provides the address of the module.
 */
exports.self = () => free_1.liftF(new Self(function_1.identity));
/**
 * tell sends a message to another actor.
 */
exports.tell = (to, m) => free_1.liftF(new Tell(to, m, undefined));
