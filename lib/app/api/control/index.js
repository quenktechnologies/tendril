...
exports.fork = exports.value = exports.noop = exports.next = exports.Noop = exports.Next = exports.Fork = exports.Value = void 0;
 ...
 */
const next = (r) => free_1.liftF(new Next(r, undefined));
exports.next = next;
/**
 * noop (does nothing).
 */
const noop = () => free_1.liftF(new Noop(undefined));
exports.noop = noop;
/**
 * value wraps a value so that it is available to the next value in the
 * chain.
 */
const value = (value) => free_1.liftF(new Value(value, function_1.identity));
exports.value = value;
/**
 * fork suspends execution for a Future to execute and provide a value.
 */
const fork = (f) => free_1.liftF(new Fork(f, function_1.identity));
exports.fork = fork;
