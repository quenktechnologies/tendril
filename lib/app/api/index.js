...
class Context {
    ...
    abort() {
        this.filters = [];
        return (0, future_1.pure)((0, free_1.pure)(undefined));
    }
    /**
    ...
    next() {
        return (this.filters.length > 0) ?
            (0, future_1.pure)(this.filters.shift()(this.request)) :
            (0, future_1.raise)(new Error(`${this.module.self()}: No more filters!`));
    }
    /**
    ...
    run() {
        this
            .next()
            .chain(n => n.foldM(() => (0, future_1.pure)(undefined), n => n.exec(this)))
            .fork(this.onError, () => { });
    }
}
 ...
 */
const doAction = (f) => (0, monad_1.doN)(f);
