...
class Response extends __1.Api {
    ...
    exec(ctx) {
        ...
        return (0, future_1.doFuture)(function* () {
            yield (0, future_1.attempt)(() => ctx.response.status(status));
            if (body.isJust())
                ctx.response.send(that.marshal(body.get()));
            ctx.response.end();
            return (that.abort ? ctx.abort() : (0, future_1.pure)(next));
        });
    }
}
...
class NoContent extends Response {
    constructor(abort, next) {
        super((0, maybe_1.nothing)(), abort, next);
        this.abort = abort;
        this.next = next;
...
class Redirect extends __1.Api {
    ...
    exec(ctx) {
        return (0, future_1.attempt)(() => ctx.response.redirect(this.url, this.code))
            .chain(() => (this.abort ? ctx.abort() : (0, future_1.pure)(this.next)));
    }
}
...
class Show extends __1.Api {
    ...
    exec(ctx) {
        ...
        let mModule = (0, data_1.getModule)(module.app.modules, self);
        if (mModule.isNothing())
            return (0, future_1.raise)(new Error(`${self}: Module not found!`));
        let mshow = mModule.get().show;
        if (mshow.isNothing())
            return (0, future_1.raise)(new Error(`${module.self()}: ` +
        ...
        return (0, future_1.doFuture)(function* () {
            let c = yield f(view, (0, record_1.merge)(ctx0, Object(ctx1)));
 ...
 */
const header = (list) => (0, free_1.liftF)(new Header(list, undefined));
exports.header = header;
/**
 ...
 */
const show = (view, context, status = 200, abort = true) => (0, free_1.liftF)(new Show(view, (0, maybe_1.fromNullable)(context), status, abort, undefined));
exports.show = show;
/**
 ...
 *                      be terminated or not.
 */
const accepted = (body, abort = true) => (0, free_1.liftF)(new Accepted((0, maybe_1.fromNullable)(body), abort, undefined));
exports.accepted = accepted;
/**
 ...
 *                      be terminated or not.
 */
const badRequest = (body, abort = true) => (0, free_1.liftF)(new BadRequest((0, maybe_1.fromNullable)(body), abort, undefined));
exports.badRequest = badRequest;
/**
 ...
 *                      be terminated or not.
 */
const conflict = (body, abort = true) => (0, free_1.liftF)(new Conflict((0, maybe_1.fromNullable)(body), abort, undefined));
exports.conflict = conflict;
/**
 ...
 *                      be terminated or not.
 */
const created = (body, abort = true) => (0, free_1.liftF)(new Created((0, maybe_1.fromNullable)(body), abort, undefined));
exports.created = created;
/**
 ...
 *                      be terminated or not.
 */
const unauthorized = (body, abort = true) => (0, free_1.liftF)(new Unauthorized((0, maybe_1.fromNullable)(body), abort, undefined));
exports.unauthorized = unauthorized;
/**
 ...
 *                      be terminated or not.
 */
const internalError = (body, abort = true) => (0, free_1.liftF)(new InternalServerError((0, maybe_1.fromNullable)(body), abort, undefined));
exports.internalError = internalError;
exports.error = exports.internalError;
/**
 ...
 *                      be terminated or not.
 */
const forbidden = (body, abort = true) => (0, free_1.liftF)(new Forbidden((0, maybe_1.fromNullable)(body), abort, undefined));
exports.forbidden = forbidden;
/**
 ...
 *                      be terminated or not.
 */
const noContent = (abort = true) => (0, free_1.liftF)(new NoContent(abort, undefined));
exports.noContent = noContent;
/**
 ...
 *                      be terminated or not.
 */
const notFound = (body, abort = true) => (0, free_1.liftF)(new NotFound((0, maybe_1.fromNullable)(body), abort, undefined));
exports.notFound = notFound;
/**
 ...
 *                      be terminated or not.
 */
const ok = (body, abort = true) => (0, free_1.liftF)(new Ok((0, maybe_1.fromNullable)(body), abort, undefined));
exports.ok = ok;
/**
 ...
 *                      be terminated or not.
 */
const redirect = (url, code, abort = true) => (0, free_1.liftF)(new Redirect(url, code, abort, undefined));
exports.redirect = redirect;
