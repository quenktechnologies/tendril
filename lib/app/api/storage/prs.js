...
class Get extends __1.Api {
    ...
    exec(ctx) {
        return (0, future_1.pure)(this.next(ctx.request.prs.get(this.key)));
    }
}
exports.Get = Get;
/**
...
class GetOrElse extends __1.Api {
    ...
    exec(ctx) {
        return (0, future_1.pure)(this.next(ctx.request.prs.getOrElse(this.key, this.value)));
    }
}
...
class Exists extends __1.Api {
    ...
    exec(ctx) {
        return (0, future_1.pure)(this.next(ctx.request.prs.exists(this.key)));
    }
}
 ...
 */
const set = (key, value) => (0, free_1.liftF)(new Set(key, value, undefined));
exports.set = set;
/**
