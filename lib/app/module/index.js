...
var Module = /** @class */ (function (_super) {
    ...
    Module.prototype.install = function (method, path, filters) {
        var _this = this;
        var maybeModule = context_1.getModule(this.system.state, this.self());
        if (maybeModule.isJust()) {
            var m = maybeModule.get();
            m.app[method](path, function (req, res) {
                return new context_2.Context(_this, req, res, filters.slice()).run();
            });
        }
    };
    Module.prototype.disable = function () {
        var _this = this;
        context_1.getModule(this.system.state, this.self())
    ...
    Module.prototype.redirect = function (location, status) {
        var _this = this;
        return context_1.getModule(this.system.state, this.self())
    ...
    Module.prototype.show = function (name, ctx) {
        return function () { return show_1.show(name, ctx); };
    };
